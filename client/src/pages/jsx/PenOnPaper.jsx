        ...
        <div className="ArtBodyContainer">
            <div id ="/penonpaper" className="ArtBody">
                <div className="ArtText">
                    Most of these are done straight to paper using ballpoint pen, using pencil is more stressful to me. 
                    Having the chance to correct mistakes means that I will never be done if I use pencil. Most of these are pretty old
                    and I don't really like the way they look anymore, and don't have much to say about them. 
                    The more recent stuff is (mostly) at the top of the page.
                </div>
