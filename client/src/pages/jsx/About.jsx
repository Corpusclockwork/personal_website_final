    ...
    return(
        <div id="/" className="AboutBodyContainer"> 
            <div className="AboutBody"> 
                Hello :D 
                <br />
                This is my personal website. My name is Lamis (see url :P), my prounous are she/her. I've been drawing for
                ...
                <br />
                <br />
                I built this website using React for the frontend, and NodeJS with Express in the backend to serve the images and animations.
                <br />
                <br />
                Have a nice day !
            </div>
