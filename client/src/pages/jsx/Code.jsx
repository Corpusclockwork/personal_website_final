            ...
            <div className="CodeBody"> 
                ...
                <ul className="ProjectsSection">
                    ...
                    <li className="project">
                        ...
                        <div className="projectDescription"> One of my friends wanted a website for *her* art, and it gave me an excuse to use Typescript, which I hadn't done before.   
                        </div>
                    </li>
                    <br />
                    <li className="project">
                        <b className="projectName"><a href="https://github.com/Corpusclockwork/C_database" target="_blank">Using csv files to construct a simple database using C</a><b className="projectState"> (IN PROGRESS)</b></b> 
                        <div className="projectDescription"> I hadn't used C since being at university, and thought it would be fun to relearn. I want to be able to add and delete rows, as well as perform searches, and joins.
                            Making my small database able to handle files sent over sockets would be nice functionality to include.
                        </div>
                    </li>
                </ul>
            </div>
