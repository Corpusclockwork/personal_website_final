const Descriptions = new Map([
    ...
    ["dias_architects.png", "Illustration to the song 'Dying is Absolutely Safe' by Architects, one of their softest songs, it is a good final song for the album it's in"],
    ...
    ["long_pig.png", "The term 'long pig' for 'human flesh used as food' dates from the mid-nineteenth century"],
    ...
    ["to_print_tllc_art.png", "An illustration for the song 'The Last Lost Continent', it is 12 minutes long but I only included the lyrics from the last 2 minutes. Highly recommend it"],
    ...
    ["plants.png", "Sometimes you miss out a line on your immortality sigil and the resulting spell leaves you not quite dead, not quite alive. Stay safe out there kids :)))"],
    ["horse.png", "Night mare :P"],
    ["growing_arms_and_legs.png", "Jira :)))))"],
]);
